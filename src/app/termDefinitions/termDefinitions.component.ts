...
export class TermDefinitionsComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        /*this.termDefinitions = [
            ...
            { Term: 'compliance non-violation instruction', Definition: 'A "compliance non-violation instruction" is a directive or set of guidelines aimed at ensuring that certain rules or regulations are followed and that no violations occur within a software system or application.  A "compliance non-violation instruction" is a directive or set of guidelines aimed at ensuring that certain rules or regulations are followed and that no violations occur within a software system or application.' }
        ];*/
    }
    ...
    processTermDefinitions() {
        ...
        this.http.post('/api/TermDefinitions', { rawInput: this.termDefinitions}).subscribe((data: IOverviewResponse) => {
            ...
            this.getOpenAIOverview.emit(data)
        })
